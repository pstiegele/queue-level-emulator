...
listeningAddress_port1 = (ip,port1)
rawSocket= socket.socket(socket.AF_INET,socket.SOCK_RAW,socket.IPPROTO_ICMP)
rawSocket.bind(listeningAddress_port1)


listeningAddress_port2 = (ip,port2)
rawSocket_2= socket.socket(socket.AF_INET,socket.SOCK_RAW,socket.IPPROTO_ICMP)
...
def _forwardtoH3():
    while(True):
        ...
        rawSocket.sendto(data,h3_address)
...
def _forwardtoH1():
    while(True):
        ...
        rawSocket.sendto(data2,h1_address)
